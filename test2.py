...
line_counter = sv.LineZone(start=sv.Point(100, 800), end=sv.Point(1700,600))
...
out = cv2.VideoWriter("results.mp4", fourcc, fps * 8, (width // 2, height // 2))
...
while cap.isOpened():
    ...
    print(f"Processing time: {processing_time:.240f} seconds")
